...
searchIndex["Aura"] = {
    ...
    "items": [
        ...
        [3, "SetAggroEnabled", "", "Sets whether the <a class=\"mod\" href=\"Creature/index.html\">Creature</a> can be aggroed by movement or not."],
    ...
    "items": [
        ...
        [3, "AddTaxiPath", "", "Adds a taxi path to a specified map, also returns pathId"],
        ...
        [3, "bit_and", "", "Returns result Documentation will need to be changed"],
        [3, "bit_lshift", "", "Returns result Documentation will need to be changed"],
        [3, "bit_not", "", "Returns result Documentation will need to be changed"],
        [3, "bit_or", "", "Returns result Documentation will need to be changed"],
        [3, "bit_rshift", "", "Returns result Documentation will need to be changed"],
        [3, "bit_xor", "", "Returns result Documentation will need to be changed"],
    ],
    "paths": []
};searchIndex["Group"] = {
    "items": [
