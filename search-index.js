...
searchIndex["Aura"] = {
    ...
    "items": [
        ...
        [3, "ClearBattleGroundEvents", "", "Unbinds all event handlers for a particular <a class=\"mod\" href=\"BattleGround/index.html\">BattleGround</a> event."],
        [3, "ClearCreatureEvents", "", "Unbinds all event handlers for a particular <a class=\"mod\" href=\"Creature/index.html\">Creature</a> event/entry combination."],
        [3, "ClearCreatureGossipEvents", "", "Unbinds all event handlers for a particular <a class=\"mod\" href=\"Creature/index.html\">Creature</a> gossip event/entry combination."],
        [3, "ClearGameObjectEvents", "", "Unbinds all event handlers for a particular <a class=\"mod\" href=\"GameObject/index.html\">GameObject</a> event/entry combination."],
        [3, "ClearGameObjectGossipEvents", "", "Unbinds all event handlers for a particular <a class=\"mod\" href=\"GameObject/index.html\">GameObject</a> gossip event/entry combination."],
        [3, "ClearGroupEvents", "", "Unbinds all event handlers for a particular <a class=\"mod\" href=\"Group/index.html\">Group</a> event."],
        [3, "ClearGuildEvents", "", "Unbinds all event handlers for a particular <a class=\"mod\" href=\"Guild/index.html\">Guild</a> event."],
        [3, "ClearItemEvents", "", "Unbinds all event handlers for a particular <a class=\"mod\" href=\"Item/index.html\">Item</a> event/entry combination."],
        [3, "ClearItemGossipEvents", "", "Unbinds all event handlers for a particular <a class=\"mod\" href=\"Item/index.html\">Item</a> gossip event/entry combination."],
        [3, "ClearPacketEvents", "", "Unbinds all event handlers for a particular [Packet] event/entry combination."],
        [3, "ClearPlayerEvents", "", "Unbinds all event handlers for a particular <a class=\"mod\" href=\"Player/index.html\">Player</a> event."],
        [3, "ClearPlayerGossipEvents", "", "Unbinds all event handlers for a particular <a class=\"mod\" href=\"Player/index.html\">Player</a> gossip event."],
        [3, "ClearServerEvents", "", "Unbinds all event handlers for a particular server event."],
        [3, "ClearUniqueCreatureEvents", "", "Unbinds all event handlers for a particular <a class=\"mod\" href=\"Creature/index.html\">Creature</a> and event combination."],
