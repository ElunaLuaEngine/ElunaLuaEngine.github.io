...
searchIndex["Aura"] = {
    "items": [
        ...
        [3, "GetSpellInfo", "", "Returns the <a class=\"mod\" href=\"SpellInfo/index.html\">SpellInfo</a> of the spell that created this <a class=\"mod\" href=\"Aura/index.html\">Aura</a>."],
    ...
    "paths": []
};searchIndex["AuraEffect"] = {
    "items": [
        [0, "", "AuraEffect", ""],
        [3, "CalculateAmount", "", "Calculates and returns the amount of the <a class=\"mod\" href=\"AuraEffect/index.html\">AuraEffect</a> for the given caster."],
        [3, "CalculatePeriodic", "", "Calculates the periodic properties of the <a class=\"mod\" href=\"AuraEffect/index.html\">AuraEffect</a> for the given caster."],
        [3, "CanBeRecalculated", "", "Returns <code>true</code> if the <a class=\"mod\" href=\"AuraEffect/index.html\">AuraEffect</a> amount can be recalculated, <code>false</code> otherwise."],
        [3, "ChangeAmount", "", "Changes the amount of the <a class=\"mod\" href=\"AuraEffect/index.html\">AuraEffect</a>."],
        [3, "GetAmount", "", "Returns the current amount of the <a class=\"mod\" href=\"AuraEffect/index.html\">AuraEffect</a>."],
        [3, "GetAmplitude", "", "Returns the amplitude in milliseconds of the <a class=\"mod\" href=\"AuraEffect/index.html\">AuraEffect</a>."],
        [3, "GetAuraType", "", "Returns the aura type of the <a class=\"mod\" href=\"AuraEffect/index.html\">AuraEffect</a>."],
        [3, "GetBase", "", "Returns the <a class=\"mod\" href=\"Aura/index.html\">Aura</a> that this <a class=\"mod\" href=\"AuraEffect/index.html\">AuraEffect</a> belongs to."],
        [3, "GetBaseAmount", "", "Returns the base amount of the <a class=\"mod\" href=\"AuraEffect/index.html\">AuraEffect</a>."],
        [3, "GetCaster", "", "Returns the <a class=\"mod\" href=\"Unit/index.html\">Unit</a> that cast the <a class=\"mod\" href=\"AuraEffect/index.html\">AuraEffect</a>."],
        [3, "GetCasterGUID", "", "Returns the GUID of the <a class=\"mod\" href=\"Unit/index.html\">Unit</a> that cast the <a class=\"mod\" href=\"AuraEffect/index.html\">AuraEffect</a>."],
        [3, "GetEffIndex", "", "Returns the effect index of the <a class=\"mod\" href=\"AuraEffect/index.html\">AuraEffect</a>."],
        [3, "GetId", "", "Returns the spell ID of the <a class=\"mod\" href=\"AuraEffect/index.html\">AuraEffect</a>."],
        [3, "GetPeriodicTimer", "", "Returns the remaining time in milliseconds until the next tick of the <a class=\"mod\" href=\"AuraEffect/index.html\">AuraEffect</a>."],
        [3, "GetRemainingTicks", "", "Returns the number of remaining ticks of the <a class=\"mod\" href=\"AuraEffect/index.html\">AuraEffect</a>."],
        [3, "GetSpellInfo", "", "Returns the <a class=\"mod\" href=\"SpellInfo/index.html\">SpellInfo</a> of the spell that created this <a class=\"mod\" href=\"AuraEffect/index.html\">AuraEffect</a>."],
        [3, "GetTargetList", "", "Returns a table of all <a class=\"mod\" href=\"Unit/index.html\">Unit</a>s currently affected by this <a class=\"mod\" href=\"AuraEffect/index.html\">AuraEffect</a>."],
        [3, "GetTickNumber", "", "Returns the current tick number of the <a class=\"mod\" href=\"AuraEffect/index.html\">AuraEffect</a>."],
        [3, "GetTotalTicks", "", "Returns the total number of ticks of the <a class=\"mod\" href=\"AuraEffect/index.html\">AuraEffect</a>."],
        [3, "RecalculateAmount", "", "Recalculates the amount of the <a class=\"mod\" href=\"AuraEffect/index.html\">AuraEffect</a>."],
        [3, "SetAmount", "", "Sets the amount of the <a class=\"mod\" href=\"AuraEffect/index.html\">AuraEffect</a>."],
        [3, "SetCanBeRecalculated", "", "Sets whether the <a class=\"mod\" href=\"AuraEffect/index.html\">AuraEffect</a> amount can be recalculated."],
        [3, "SetPeriodicTimer", "", "Sets the periodic timer of the <a class=\"mod\" href=\"AuraEffect/index.html\">AuraEffect</a>."],
    ],
    "paths": []
    ...
    "paths": []
};searchIndex["ElunaProcInfo"] = {
    "items": [
        [0, "", "ElunaProcInfo", ""],
        [3, "GetActionTarget", "", "Returns the target <a class=\"mod\" href=\"Unit/index.html\">Unit</a> of the proc event action."],
        [3, "GetActor", "", "Returns the <a class=\"mod\" href=\"Unit/index.html\">Unit</a> that triggered the proc event."],
        [3, "GetAttackType", "", "Returns the weapon attack type of the proc event."],
        [3, "GetBlock", "", "Returns the amount of damage blocked in the proc event."],
        [3, "GetDamage", "", "Returns the damage dealt in the proc event."],
        [3, "GetDamageAbsorb", "", "Returns the amount of damage absorbed in the proc event."],
        [3, "GetDamageType", "", "Returns the damage effect type of the proc event."],
        [3, "GetEffectiveHeal", "", "Returns the effective healing done in the proc event, after overhealing is subtracted."],
        [3, "GetHeal", "", "Returns the amount of healing done in the proc event."],
        [3, "GetHealAbsorb", "", "Returns the amount of healing absorbed in the proc event."],
        [3, "GetHitMask", "", "Returns the hit mask of the proc event."],
        [3, "GetMap", "", "Returns the <a class=\"mod\" href=\"Map/index.html\">Map</a> the proc event occurred on."],
        [3, "GetProcSpell", "", "Returns the <a class=\"mod\" href=\"Spell/index.html\">Spell</a> that triggered the proc event, or nil if the proc was not triggered by a spell."],
        [3, "GetResist", "", "Returns the amount of damage resisted in the proc event."],
        [3, "GetSchoolMask", "", "Returns the school mask of the proc event."],
        [3, "GetSpellInfo", "", "Returns the <a class=\"mod\" href=\"SpellInfo/index.html\">SpellInfo</a> of the spell that triggered the proc event."],
        [3, "GetSpellPhaseMask", "", "Returns the spell phase mask of the proc event."],
        [3, "GetSpellTypeMask", "", "Returns the spell type mask of the proc event."],
        [3, "GetTypeMask", "", "Returns the type mask of the proc event."],
        [3, "HasDamage", "", "Returns <code>true</code> if the proc event involved damage, <code>false</code> otherwise."],
        [3, "HasHeal", "", "Returns <code>true</code> if the proc event involved healing, <code>false</code> otherwise."],
        [3, "SetAbsorbDamage", "", "Sets the absorbed damage of the proc event."],
        [3, "SetAbsorbHeal", "", "Sets the absorbed healing of the proc event."],
        [3, "SetBlockDamage", "", "Sets the blocked damage of the proc event."],
        [3, "SetDamage", "", "Sets the damage of the proc event."],
        [3, "SetEffectiveHeal", "", "Sets the effective healing of the proc event."],
        [3, "SetHeal", "", "Sets the healing of the proc event."],
        [3, "SetResistDamage", "", "Sets the resisted damage of the proc event."],
    ],
    "paths": []
    ...
    "items": [
        ...
        [3, "GetSpellInfo", "", "Returns the <a class=\"mod\" href=\"SpellInfo/index.html\">SpellInfo</a> for the given spell ID, or nil if the spell does not exist."],
    ...
    "items": [
        ...
        [3, "GetArmor", "", "Returns the base armor of this <a class=\"mod\" href=\"Item/index.html\">Item</a>"],
        ...
        [3, "GetDamageInfo", "", "Returns the damage info of the specified damage slot of this <a class=\"mod\" href=\"Item/index.html\">Item</a>"],
        [3, "GetDisplayId", "", "Returns the display ID of the <a class=\"mod\" href=\"Item/index.html\">Item</a>"],
        [3, "GetDurability", "", "Returns the current durability of this <a class=\"mod\" href=\"Item/index.html\">Item</a>"],
        ...
        [3, "GetMaxDurability", "", "Returns the max durability of this <a class=\"mod\" href=\"Item/index.html\">Item</a>"],
        ...
        [3, "GetSpeed", "", "Returns the base attack speed of this <a class=\"mod\" href=\"Item/index.html\">Item</a>"],
        ...
        [3, "GetStatInfo", "", "Returns the stat info of the specified stat slot of this <a class=\"mod\" href=\"Item/index.html\">Item</a>"],
    ...
    "items": [
        ...
        [3, "AddLifetimeKills", "", "Adds or detracts from the <a class=\"mod\" href=\"Player/index.html\">Player</a>s current lifetime kill count"],
        [3, "AddQuest", "", "Tries to add the given quest entry for the <a class=\"mod\" href=\"Player/index.html\">Player</a>."],
        [3, "AddTalent", "", "Adds a talent to the <a class=\"mod\" href=\"Player/index.html\">Player</a> for the specified spec and learning status."],
        ...
        [3, "BindToInstance", "", "Binds the <a class=\"mod\" href=\"Player/index.html\">Player</a> to their current instance."],
        ...
        [3, "GetNearbyGameObject", "", "Returns the closest <a class=\"mod\" href=\"GameObject/index.html\">GameObject</a> to the <a class=\"mod\" href=\"Player/index.html\">Player</a>."],
        ...
        [3, "GetRecruiterId", "", "Returns the <a class=\"mod\" href=\"Player/index.html\">Player</a>s recruit-a-friend recruiter account ID"],
        ...
        [3, "GetSelectedPlayer", "", "Returns the <a class=\"mod\" href=\"Player/index.html\">Player</a>s selected <a class=\"mod\" href=\"Player/index.html\">Player</a> or nil."],
        [3, "GetSelectedUnit", "", "Returns the <a class=\"mod\" href=\"Player/index.html\">Player</a>s selected <a class=\"mod\" href=\"Unit/index.html\">Unit</a>."],
        ...
        [3, "HasPendingBind", "", "Returns whether or not the <a class=\"mod\" href=\"Player/index.html\">Player</a> has any pending dungeon bind"],
        ...
        [3, "HasReceivedQuestReward", "", "Returns whether or not the <a class=\"mod\" href=\"Player/index.html\">Player</a> has received the reward for a specific <a class=\"mod\" href=\"Quest/index.html\">Quest</a> ID"],
        [3, "HasRecruited", "", "Returns whether or not the <a class=\"mod\" href=\"Player/index.html\">Player</a> recruited the other <a class=\"mod\" href=\"Player/index.html\">Player</a>"],
        ...
        [3, "InRandomLfgDungeon", "", "Returns whether or not the <a class=\"mod\" href=\"Player/index.html\">Player</a> is currently in a random LFG dungeon"],
        ...
        [3, "IsARecruiter", "", "Returns whether or not the <a class=\"mod\" href=\"Player/index.html\">Player</a> is a recruiter"],
        ...
        [3, "IsImmuneToEnvironmentalDamage", "", "Returns whether or not the <a class=\"mod\" href=\"Player/index.html\">Player</a> is currently immune to environmental damage"],
        ...
        [3, "IsNeverVisible", "", "Returns whether or not the <a class=\"mod\" href=\"Player/index.html\">Player</a> is never visible for other <a class=\"mod\" href=\"Unit/index.html\">Unit</a>s"],
        [3, "IsOutdoorPvPActive", "", "Returns whether or not the <a class=\"mod\" href=\"Player/index.html\">Player</a> is currently flagged for outdoors PvP"],
        [3, "IsRecruited", "", "Returns whether or not the <a class=\"mod\" href=\"Player/index.html\">Player</a> has been recruited"],
        ...
        [3, "IsUsingLfg", "", "Returns whether or not the <a class=\"mod\" href=\"Player/index.html\">Player</a> is currently queued in LFG"],
        ...
        [3, "KillGOCredit", "", "Grants kill credit for a specific [Craeture] or <a class=\"mod\" href=\"GameObject/index.html\">GameObject</a>."],
        ...
        [3, "KilledPlayerCredit", "", "Grants a player kill credit."],
        ...
        [3, "RemoveActiveQuest", "", "Removes an active quest from the <a class=\"mod\" href=\"Player/index.html\">Player</a>."],
        ...
        [3, "RemovePet", "", "Removes the <a class=\"mod\" href=\"Player/index.html\">Player</a>'s active pet."],
        [3, "RemoveQuest", "", "Removes the given quest entry from the <a class=\"mod\" href=\"Player/index.html\">Player</a>."],
        [3, "RemoveRewardedQuest", "", "Removes a quest from the rewarded quests for the <a class=\"mod\" href=\"Player/index.html\">Player</a>."],
        ...
        [3, "SetMovement", "", "Sets the <a class=\"mod\" href=\"Player/index.html\">Player</a>s movement to the provided movement type"],
        ...
        [3, "SummonPet", "", "Summons a pet for the <a class=\"mod\" href=\"Player/index.html\">Player</a>."],
    ...
    "items": [
        ...
        [3, "CalculateDamage", "", "Calculates the damage for the given effect index of the <a class=\"mod\" href=\"Spell/index.html\">Spell</a>."],
        [3, "Cancel", "", "Cancels the <a class=\"mod\" href=\"Spell/index.html\">Spell</a>."],
        [3, "Cast", "", "Casts the <a class=\"mod\" href=\"Spell/index.html\">Spell</a>."],
        [3, "CleanupTargetList", "", "Cleans up the target list of the <a class=\"mod\" href=\"Spell/index.html\">Spell</a>."],
        ...
        [3, "GetDelayMoment", "", "Returns the delay moment of the <a class=\"mod\" href=\"Spell/index.html\">Spell</a>."],
        [3, "GetDelayStart", "", "Returns the delay start time of the <a class=\"mod\" href=\"Spell/index.html\">Spell</a>."],
        ...
        [3, "GetGameObjectTargetCountForEffect", "", "Returns the number of GameObject targets for the given effect index of the <a class=\"mod\" href=\"Spell/index.html\">Spell</a>."],
        [3, "GetItemTargetCountForEffect", "", "Returns the number of item targets for the given effect index of the <a class=\"mod\" href=\"Spell/index.html\">Spell</a>."],
        [3, "GetOriginalCaster", "", "Returns the original caster <a class=\"mod\" href=\"Unit/index.html\">Unit</a> of the <a class=\"mod\" href=\"Spell/index.html\">Spell</a>."],
        [3, "GetPowerCost", "", "Returns the power cost of the <a class=\"mod\" href=\"Spell/index.html\">Spell</a>."],
        [3, "GetRuneState", "", "Returns the rune state of the <a class=\"mod\" href=\"Spell/index.html\">Spell</a>."],
        [3, "GetSpellInfo", "", "Returns the <a class=\"mod\" href=\"SpellInfo/index.html\">SpellInfo</a> of the spell that created this <a class=\"mod\" href=\"Spell/index.html\">Spell</a>."],
        [3, "GetState", "", "Returns the current state of the <a class=\"mod\" href=\"Spell/index.html\">Spell</a>."],
        ...
        [3, "GetUnitTargetCountForEffect", "", "Returns the number of unit targets for the given effect index of the <a class=\"mod\" href=\"Spell/index.html\">Spell</a>."],
        [3, "IsAutoActionResetSpell", "", "Returns <code>true</code> if the <a class=\"mod\" href=\"Spell/index.html\">Spell</a> is an auto action reset spell, <code>false</code> otherwise."],
        ...
        [3, "IsChannelActive", "", "Returns <code>true</code> if the <a class=\"mod\" href=\"Spell/index.html\">Spell</a> channel is active, <code>false</code> otherwise."],
        [3, "IsDeletable", "", "Returns <code>true</code> if the <a class=\"mod\" href=\"Spell/index.html\">Spell</a> is deletable, <code>false</code> otherwise."],
        [3, "IsIgnoringCooldowns", "", "Returns <code>true</code> if the <a class=\"mod\" href=\"Spell/index.html\">Spell</a> is ignoring cooldowns, <code>false</code> otherwise."],
        [3, "IsInterruptable", "", "Returns <code>true</code> if the <a class=\"mod\" href=\"Spell/index.html\">Spell</a> is interruptable, <code>false</code> otherwise."],
        [3, "IsNeedSendToClient", "", "Returns <code>true</code> if the <a class=\"mod\" href=\"Spell/index.html\">Spell</a> needs to be sent to the client, <code>false</code> otherwise."],
        [3, "IsPositive", "", "Returns <code>true</code> if the <a class=\"mod\" href=\"Spell/index.html\">Spell</a> is positive, <code>false</code> otherwise."],
        [3, "IsProcDisabled", "", "Returns <code>true</code> if the <a class=\"mod\" href=\"Spell/index.html\">Spell</a> proc is disabled, <code>false</code> otherwise."],
        [3, "IsTriggered", "", "Returns <code>true</code> if the <a class=\"mod\" href=\"Spell/index.html\">Spell</a> is triggered, <code>false</code> otherwise."],
        [3, "IsTriggeredByAura", "", "Returns <code>true</code> if the <a class=\"mod\" href=\"Spell/index.html\">Spell</a> was triggered by the given <a class=\"mod\" href=\"SpellInfo/index.html\">SpellInfo</a>, <code>false</code> otherwise."],
        [3, "SetAutoRepeat", "", "Sets the <a class=\"mod\" href=\"Spell/index.html\">Spell</a> to automatically repeat."],
        [3, "SetDelayStart", "", "Sets the delay start time of the <a class=\"mod\" href=\"Spell/index.html\">Spell</a>."],
        [3, "SetExecutedCurrently", "", "Sets whether the <a class=\"mod\" href=\"Spell/index.html\">Spell</a> is currently being executed."],
        [3, "SetReferencedFromCurrent", "", "Sets whether the <a class=\"mod\" href=\"Spell/index.html\">Spell</a> is referenced from the current spell."],
        [3, "SetRuneState", "", "Sets the rune state of the <a class=\"mod\" href=\"Spell/index.html\">Spell</a>."],
        [3, "SetSpellValue", "", "Sets a spell value modifier on the <a class=\"mod\" href=\"Spell/index.html\">Spell</a>."],
        [3, "SetState", "", "Sets the state of the <a class=\"mod\" href=\"Spell/index.html\">Spell</a>."],
        [3, "UpdatePointers", "", "Updates the <a class=\"mod\" href=\"Spell/index.html\">Spell</a>'s pointers. Must be used after time delays on non-triggered spell casts."],
    ],
    "paths": []
};searchIndex["SpellInfo"] = {
    "items": [
        [0, "", "SpellInfo", ""],
        [3, "CalcCastTime", "", "Returns the calculated cast time in milliseconds of the <a class=\"mod\" href=\"SpellInfo/index.html\">SpellInfo</a>."],
        [3, "CanBeUsedInCombat", "", "Returns <code>true</code> if the <a class=\"mod\" href=\"SpellInfo/index.html\">SpellInfo</a> can be used in combat, <code>false</code> otherwise."],
        [3, "CanDispelAura", "", "Returns <code>true</code> if the <a class=\"mod\" href=\"SpellInfo/index.html\">SpellInfo</a> can dispel the given <a class=\"mod\" href=\"SpellInfo/index.html\">SpellInfo</a>, <code>false</code> otherwise."],
        [3, "CanPierceImmuneAura", "", "Returns <code>true</code> if the <a class=\"mod\" href=\"SpellInfo/index.html\">SpellInfo</a> can pierce the immunity provided by the given <a class=\"mod\" href=\"SpellInfo/index.html\">SpellInfo</a>, <code>false</code> otherwise."],
        [3, "CanSpellProvideImmunityAgainstAura", "", "Returns <code>true</code> if the <a class=\"mod\" href=\"SpellInfo/index.html\">SpellInfo</a> can provide immunity against the given <a class=\"mod\" href=\"SpellInfo/index.html\">SpellInfo</a>, <code>false</code> otherwise."],
        [3, "CheckTarget", "", "Checks whether the <a class=\"mod\" href=\"SpellInfo/index.html\">SpellInfo</a> can be cast on the given target by the given caster. Returns the [SpellCastResult] of the check."],
        [3, "CheckTargetCreatureType", "", "Returns <code>true</code> if the given <a class=\"mod\" href=\"Unit/index.html\">Unit</a> matches the required creature type for the <a class=\"mod\" href=\"SpellInfo/index.html\">SpellInfo</a>, <code>false</code> otherwise."],
        [3, "EffectIsAreaAuraEffect", "", "Returns <code>true</code> if the given effect slot of the <a class=\"mod\" href=\"SpellInfo/index.html\">SpellInfo</a> is an area aura effect, <code>false</code> otherwise."],
        [3, "EffectIsAura", "", "Returns <code>true</code> if the given effect slot of the <a class=\"mod\" href=\"SpellInfo/index.html\">SpellInfo</a> applies an aura, <code>false</code> otherwise."],
        [3, "EffectIsAuraType", "", "Returns <code>true</code> if the given effect slot of the <a class=\"mod\" href=\"SpellInfo/index.html\">SpellInfo</a> applies the given aura type, <code>false</code> otherwise."],
        [3, "EffectIsEffect", "", "Returns <code>true</code> if the given effect slot of the <a class=\"mod\" href=\"SpellInfo/index.html\">SpellInfo</a> is an effect, <code>false</code> otherwise."],
        [3, "EffectIsEffectType", "", "Returns <code>true</code> if the given effect slot of the <a class=\"mod\" href=\"SpellInfo/index.html\">SpellInfo</a> is the given effect type, <code>false</code> otherwise."],
        [3, "EffectIsTargetingArea", "", "Returns <code>true</code> if the given effect slot of the <a class=\"mod\" href=\"SpellInfo/index.html\">SpellInfo</a> is targeting an area, <code>false</code> otherwise."],
        [3, "EffectIsUnitOwnedAuraEffect", "", "Returns <code>true</code> if the given effect slot of the <a class=\"mod\" href=\"SpellInfo/index.html\">SpellInfo</a> is a unit owned aura effect, <code>false</code> otherwise."],
        [3, "GetActiveIconID", "", "Returns the active icon ID of the <a class=\"mod\" href=\"SpellInfo/index.html\">SpellInfo</a>."],
        [3, "GetAllEffectsMechanicMask", "", "Returns a bitmask of all mechanics used across all effects of the <a class=\"mod\" href=\"SpellInfo/index.html\">SpellInfo</a>."],
        [3, "GetAllowedMechanicMask", "", "Returns the allowed mechanic mask of the <a class=\"mod\" href=\"SpellInfo/index.html\">SpellInfo</a>."],
        [3, "GetAreaGroupId", "", "Returns the area group ID of the <a class=\"mod\" href=\"SpellInfo/index.html\">SpellInfo</a>."],
        [3, "GetAttackType", "", "Returns the weapon attack type of the <a class=\"mod\" href=\"SpellInfo/index.html\">SpellInfo</a>."],
        [3, "GetAttributes", "", "Returns the attributes of the <a class=\"mod\" href=\"SpellInfo/index.html\">SpellInfo</a>."],
        [3, "GetAttributesCu", "", "Returns the custom attributes of the <a class=\"mod\" href=\"SpellInfo/index.html\">SpellInfo</a>."],
        [3, "GetAttributesEx", "", "Returns the first extended attributes of the <a class=\"mod\" href=\"SpellInfo/index.html\">SpellInfo</a>."],
        [3, "GetAttributesEx2", "", "Returns the second extended attributes of the <a class=\"mod\" href=\"SpellInfo/index.html\">SpellInfo</a>."],
        [3, "GetAttributesEx3", "", "Returns the third extended attributes of the <a class=\"mod\" href=\"SpellInfo/index.html\">SpellInfo</a>."],
        [3, "GetAttributesEx4", "", "Returns the fourth extended attributes of the <a class=\"mod\" href=\"SpellInfo/index.html\">SpellInfo</a>."],
        [3, "GetAttributesEx5", "", "Returns the fifth extended attributes of the <a class=\"mod\" href=\"SpellInfo/index.html\">SpellInfo</a>."],
        [3, "GetAttributesEx6", "", "Returns the sixth extended attributes of the <a class=\"mod\" href=\"SpellInfo/index.html\">SpellInfo</a>."],
        [3, "GetAttributesEx7", "", "Returns the seventh extended attributes of the <a class=\"mod\" href=\"SpellInfo/index.html\">SpellInfo</a>."],
        [3, "GetAuraInterruptFlags", "", "Returns the aura interrupt flags of the <a class=\"mod\" href=\"SpellInfo/index.html\">SpellInfo</a>."],
        [3, "GetAuraState", "", "Returns the aura state of the <a class=\"mod\" href=\"SpellInfo/index.html\">SpellInfo</a>."],
        [3, "GetBaseLevel", "", "Returns the base level required to cast the <a class=\"mod\" href=\"SpellInfo/index.html\">SpellInfo</a>."],
        [3, "GetCasterAuraSpell", "", "Returns the spell ID that must be active on the caster to cast the <a class=\"mod\" href=\"SpellInfo/index.html\">SpellInfo</a>."],
        [3, "GetCasterAuraState", "", "Returns the caster aura state required to cast the <a class=\"mod\" href=\"SpellInfo/index.html\">SpellInfo</a>."],
        [3, "GetCasterAuraStateNot", "", "Returns the caster aura state that prevents casting the <a class=\"mod\" href=\"SpellInfo/index.html\">SpellInfo</a>."],
        [3, "GetCategory", "", "Returns the category of the <a class=\"mod\" href=\"SpellInfo/index.html\">SpellInfo</a>."],
        [3, "GetCategoryRecoveryTime", "", "Returns the category recovery time in milliseconds of the <a class=\"mod\" href=\"SpellInfo/index.html\">SpellInfo</a>."],
        [3, "GetChannelInterruptFlags", "", "Returns the channel interrupt flags of the <a class=\"mod\" href=\"SpellInfo/index.html\">SpellInfo</a>."],
        [3, "GetDiminishingReturnsGroupForSpell", "", "Returns the diminishing returns group for the <a class=\"mod\" href=\"SpellInfo/index.html\">SpellInfo</a>."],
        [3, "GetDiminishingReturnsGroupType", "", "Returns the diminishing returns group type for the <a class=\"mod\" href=\"SpellInfo/index.html\">SpellInfo</a>."],
        [3, "GetDiminishingReturnsLimitDuration", "", "Returns the diminishing returns limit duration in milliseconds for the <a class=\"mod\" href=\"SpellInfo/index.html\">SpellInfo</a>."],
        [3, "GetDiminishingReturnsMaxLevel", "", "Returns the diminishing returns max level for the <a class=\"mod\" href=\"SpellInfo/index.html\">SpellInfo</a>."],
        [3, "GetDispel", "", "Returns the dispel type of the <a class=\"mod\" href=\"SpellInfo/index.html\">SpellInfo</a>."],
        [3, "GetDmgClass", "", "Returns the damage class of the <a class=\"mod\" href=\"SpellInfo/index.html\">SpellInfo</a>."],
        [3, "GetDuration", "", "Returns the duration in milliseconds of the <a class=\"mod\" href=\"SpellInfo/index.html\">SpellInfo</a>."],
        [3, "GetEffectAmplitude", "", "Returns the amplitude in milliseconds of the given effect slot of the <a class=\"mod\" href=\"SpellInfo/index.html\">SpellInfo</a>."],
        [3, "GetEffectApplyAuraName", "", "Returns the aura type applied by the given effect slot of the <a class=\"mod\" href=\"SpellInfo/index.html\">SpellInfo</a>."],
        [3, "GetEffectBasePoints", "", "Returns the base points of the given effect slot of the <a class=\"mod\" href=\"SpellInfo/index.html\">SpellInfo</a>."],
        [3, "GetEffectBonusMultiplier", "", "Returns the bonus multiplier of the given effect slot of the <a class=\"mod\" href=\"SpellInfo/index.html\">SpellInfo</a>."],
        [3, "GetEffectCalcRadius", "", "Returns the calculated radius for the given effect slot of the <a class=\"mod\" href=\"SpellInfo/index.html\">SpellInfo</a>."],
        [3, "GetEffectCalcValue", "", "Returns the calculated value for the given effect slot of the <a class=\"mod\" href=\"SpellInfo/index.html\">SpellInfo</a>."],
        [3, "GetEffectChainTarget", "", "Returns the chain target count of the given effect slot of the <a class=\"mod\" href=\"SpellInfo/index.html\">SpellInfo</a>."],
        [3, "GetEffectDamageMultiplier", "", "Returns the damage multiplier of the given effect slot of the <a class=\"mod\" href=\"SpellInfo/index.html\">SpellInfo</a>."],
        [3, "GetEffectDieSides", "", "Returns the die sides of the given effect slot of the <a class=\"mod\" href=\"SpellInfo/index.html\">SpellInfo</a>."],
        [3, "GetEffectHasRadius", "", "Returns <code>true</code> if the given effect slot of the <a class=\"mod\" href=\"SpellInfo/index.html\">SpellInfo</a> has a radius, <code>false</code> otherwise."],
        [3, "GetEffectImplicitTargetType", "", "Returns the implicit target type for the given effect slot of the <a class=\"mod\" href=\"SpellInfo/index.html\">SpellInfo</a>."],
        [3, "GetEffectIndex", "", "Returns the effect index of the given effect slot of the <a class=\"mod\" href=\"SpellInfo/index.html\">SpellInfo</a>."],
        [3, "GetEffectItemType", "", "Returns the item type entry of the given effect slot of the <a class=\"mod\" href=\"SpellInfo/index.html\">SpellInfo</a>."],
        [3, "GetEffectMechanic", "", "Returns the mechanic for the given effect index of the <a class=\"mod\" href=\"SpellInfo/index.html\">SpellInfo</a>."],
        [3, "GetEffectMechanicMask", "", "Returns the mechanic mask for the given effect index of the <a class=\"mod\" href=\"SpellInfo/index.html\">SpellInfo</a>."],
        [3, "GetEffectMiscValue", "", "Returns the misc value of the given effect slot of the <a class=\"mod\" href=\"SpellInfo/index.html\">SpellInfo</a>."],
        [3, "GetEffectMiscValueB", "", "Returns the secondary misc value of the given effect slot of the <a class=\"mod\" href=\"SpellInfo/index.html\">SpellInfo</a>."],
        [3, "GetEffectPointsPerComboPoint", "", "Returns the points per combo point of the given effect slot of the <a class=\"mod\" href=\"SpellInfo/index.html\">SpellInfo</a>."],
        [3, "GetEffectProvidedTargetMask", "", "Returns the provided target mask for the given effect slot of the <a class=\"mod\" href=\"SpellInfo/index.html\">SpellInfo</a>."],
        [3, "GetEffectRealPointsPerLevel", "", "Returns the real points per level of the given effect slot of the <a class=\"mod\" href=\"SpellInfo/index.html\">SpellInfo</a>."],
        [3, "GetEffectSpellClassMask", "", "Returns the spell class mask component at the given mask index for the given effect slot of the <a class=\"mod\" href=\"SpellInfo/index.html\">SpellInfo</a>. The mask is a 96-bit value split into three uint32 components (index 0-2)."],
        [3, "GetEffectTargetACheckType", "", "Returns the target A check type of the given effect slot of the <a class=\"mod\" href=\"SpellInfo/index.html\">SpellInfo</a>."],
        [3, "GetEffectTargetADirectionAngle", "", "Returns the calculated direction angle for target A of the given effect slot of the <a class=\"mod\" href=\"SpellInfo/index.html\">SpellInfo</a>."],
        [3, "GetEffectTargetADirectionType", "", "Returns the target A direction type of the given effect slot of the <a class=\"mod\" href=\"SpellInfo/index.html\">SpellInfo</a>."],
        [3, "GetEffectTargetAIsArea", "", "Returns <code>true</code> if target A of the given effect slot of the <a class=\"mod\" href=\"SpellInfo/index.html\">SpellInfo</a> is an area target, <code>false</code> otherwise."],
        [3, "GetEffectTargetAObjectType", "", "Returns the target A object type of the given effect slot of the <a class=\"mod\" href=\"SpellInfo/index.html\">SpellInfo</a>."],
        [3, "GetEffectTargetAReferenceType", "", "Returns the target A reference type of the given effect slot of the <a class=\"mod\" href=\"SpellInfo/index.html\">SpellInfo</a>."],
        [3, "GetEffectTargetASelectionCategory", "", "Returns the target A selection category of the given effect slot of the <a class=\"mod\" href=\"SpellInfo/index.html\">SpellInfo</a>."],
        [3, "GetEffectTargetATarget", "", "Returns the target A type of the given effect slot of the <a class=\"mod\" href=\"SpellInfo/index.html\">SpellInfo</a>."],
        [3, "GetEffectTargetBCheckType", "", "Returns the target B check type of the given effect slot of the <a class=\"mod\" href=\"SpellInfo/index.html\">SpellInfo</a>."],
        [3, "GetEffectTargetBDirectionAngle", "", "Returns the calculated direction angle for target B of the given effect slot of the <a class=\"mod\" href=\"SpellInfo/index.html\">SpellInfo</a>."],
        [3, "GetEffectTargetBDirectionType", "", "Returns the target B direction type of the given effect slot of the <a class=\"mod\" href=\"SpellInfo/index.html\">SpellInfo</a>."],
        [3, "GetEffectTargetBIsArea", "", "Returns <code>true</code> if target B of the given effect slot of the <a class=\"mod\" href=\"SpellInfo/index.html\">SpellInfo</a> is an area target, <code>false</code> otherwise."],
        [3, "GetEffectTargetBObjectType", "", "Returns the target B object type of the given effect slot of the <a class=\"mod\" href=\"SpellInfo/index.html\">SpellInfo</a>."],
        [3, "GetEffectTargetBReferenceType", "", "Returns the target B reference type of the given effect slot of the <a class=\"mod\" href=\"SpellInfo/index.html\">SpellInfo</a>."],
        [3, "GetEffectTargetBSelectionCategory", "", "Returns the target B selection category of the given effect slot of the <a class=\"mod\" href=\"SpellInfo/index.html\">SpellInfo</a>."],
        [3, "GetEffectTargetBTarget", "", "Returns the target B type of the given effect slot of the <a class=\"mod\" href=\"SpellInfo/index.html\">SpellInfo</a>."],
        [3, "GetEffectTriggerSpell", "", "Returns the trigger spell ID of the given effect slot of the <a class=\"mod\" href=\"SpellInfo/index.html\">SpellInfo</a>."],
        [3, "GetEffectType", "", "Returns the effect type of the given effect slot of the <a class=\"mod\" href=\"SpellInfo/index.html\">SpellInfo</a>."],
        [3, "GetEffectUsedTargetObjectType", "", "Returns the used target object type for the given effect slot of the <a class=\"mod\" href=\"SpellInfo/index.html\">SpellInfo</a>."],
        [3, "GetEffectValueMultiplier", "", "Returns the value multiplier of the given effect slot of the <a class=\"mod\" href=\"SpellInfo/index.html\">SpellInfo</a>."],
        [3, "GetEquippedItemClass", "", "Returns the required equipped item class of the <a class=\"mod\" href=\"SpellInfo/index.html\">SpellInfo</a>."],
        [3, "GetEquippedItemInventoryTypeMask", "", "Returns the required equipped item inventory type mask of the <a class=\"mod\" href=\"SpellInfo/index.html\">SpellInfo</a>."],
        [3, "GetEquippedItemSubClassMask", "", "Returns the required equipped item subclass mask of the <a class=\"mod\" href=\"SpellInfo/index.html\">SpellInfo</a>."],
        [3, "GetExcludeCasterAuraSpell", "", "Returns the spell ID that must not be active on the caster to cast the <a class=\"mod\" href=\"SpellInfo/index.html\">SpellInfo</a>."],
        [3, "GetExcludeTargetAuraSpell", "", "Returns the spell ID that must not be active on the target to cast the <a class=\"mod\" href=\"SpellInfo/index.html\">SpellInfo</a>."],
        [3, "GetExplicitTargetMask", "", "Returns the explicit target mask of the <a class=\"mod\" href=\"SpellInfo/index.html\">SpellInfo</a>."],
        [3, "GetFacingCasterFlags", "", "Returns the facing caster flags of the <a class=\"mod\" href=\"SpellInfo/index.html\">SpellInfo</a>."],
        [3, "GetId", "", "Returns the ID of the <a class=\"mod\" href=\"SpellInfo/index.html\">SpellInfo</a>."],
        [3, "GetInterruptFlags", "", "Returns the interrupt flags of the <a class=\"mod\" href=\"SpellInfo/index.html\">SpellInfo</a>."],
        [3, "GetManaCost", "", "Returns the mana cost of the <a class=\"mod\" href=\"SpellInfo/index.html\">SpellInfo</a>."],
        [3, "GetManaCostPercentage", "", "Returns the mana cost percentage of the <a class=\"mod\" href=\"SpellInfo/index.html\">SpellInfo</a>."],
        [3, "GetManaCostPerlevel", "", "Returns the mana cost per level of the <a class=\"mod\" href=\"SpellInfo/index.html\">SpellInfo</a>."],
        [3, "GetManaPerSecond", "", "Returns the mana per second drain of the <a class=\"mod\" href=\"SpellInfo/index.html\">SpellInfo</a>."],
        [3, "GetManaPerSecondPerLevel", "", "Returns the mana per second per level drain of the <a class=\"mod\" href=\"SpellInfo/index.html\">SpellInfo</a>."],
        [3, "GetMaxAffectedTargets", "", "Returns the maximum number of affected targets of the <a class=\"mod\" href=\"SpellInfo/index.html\">SpellInfo</a>."],
        [3, "GetMaxDuration", "", "Returns the maximum duration in milliseconds of the <a class=\"mod\" href=\"SpellInfo/index.html\">SpellInfo</a>."],
        [3, "GetMaxLevel", "", "Returns the maximum level of the <a class=\"mod\" href=\"SpellInfo/index.html\">SpellInfo</a>."],
        [3, "GetMaxRange", "", "Returns the maximum range of the <a class=\"mod\" href=\"SpellInfo/index.html\">SpellInfo</a>."],
        [3, "GetMaxTargetLevel", "", "Returns the maximum target level of the <a class=\"mod\" href=\"SpellInfo/index.html\">SpellInfo</a>."],
        [3, "GetMaxTicks", "", "Returns the maximum number of ticks of the <a class=\"mod\" href=\"SpellInfo/index.html\">SpellInfo</a>."],
        [3, "GetMechanic", "", "Returns the mechanic of the <a class=\"mod\" href=\"SpellInfo/index.html\">SpellInfo</a>."],
        [3, "GetMinRange", "", "Returns the minimum range of the <a class=\"mod\" href=\"SpellInfo/index.html\">SpellInfo</a>."],
        [3, "GetPowerType", "", "Returns the power type of the <a class=\"mod\" href=\"SpellInfo/index.html\">SpellInfo</a>."],
        [3, "GetPreventionType", "", "Returns the prevention type of the <a class=\"mod\" href=\"SpellInfo/index.html\">SpellInfo</a>."],
        [3, "GetPriority", "", "Returns the priority of the <a class=\"mod\" href=\"SpellInfo/index.html\">SpellInfo</a>."],
        [3, "GetProcChance", "", "Returns the proc chance of the <a class=\"mod\" href=\"SpellInfo/index.html\">SpellInfo</a>."],
        [3, "GetProcCharges", "", "Returns the proc charges of the <a class=\"mod\" href=\"SpellInfo/index.html\">SpellInfo</a>."],
        [3, "GetProcFlags", "", "Returns the proc flags of the <a class=\"mod\" href=\"SpellInfo/index.html\">SpellInfo</a>."],
        [3, "GetRank", "", "Returns the rank of the <a class=\"mod\" href=\"SpellInfo/index.html\">SpellInfo</a>."],
        [3, "GetReagent", "", "Returns the reagent entry at the given index for the <a class=\"mod\" href=\"SpellInfo/index.html\">SpellInfo</a>."],
        [3, "GetReagentCount", "", "Returns the reagent count at the given index for the <a class=\"mod\" href=\"SpellInfo/index.html\">SpellInfo</a>."],
        [3, "GetRecoveryTime", "", "Returns the recovery time in milliseconds of the <a class=\"mod\" href=\"SpellInfo/index.html\">SpellInfo</a>."],
        [3, "GetRequiresSpellFocus", "", "Returns the requires spell focus entry of the <a class=\"mod\" href=\"SpellInfo/index.html\">SpellInfo</a>."],
        [3, "GetRuneCostID", "", "Returns the rune cost ID of the <a class=\"mod\" href=\"SpellInfo/index.html\">SpellInfo</a>."],
        [3, "GetSchoolMask", "", "Returns the school mask of the <a class=\"mod\" href=\"SpellInfo/index.html\">SpellInfo</a>."],
        [3, "GetSpeed", "", "Returns the projectile speed of the <a class=\"mod\" href=\"SpellInfo/index.html\">SpellInfo</a>."],
        [3, "GetSpellFamilyFlags", "", "Returns the spell family flags of the <a class=\"mod\" href=\"SpellInfo/index.html\">SpellInfo</a> at the given index. The flags are a 96-bit value split into three uint32 components (index 0-2)."],
        [3, "GetSpellFamilyName", "", "Returns the spell family name of the <a class=\"mod\" href=\"SpellInfo/index.html\">SpellInfo</a>."],
        [3, "GetSpellIconID", "", "Returns the spell icon ID of the <a class=\"mod\" href=\"SpellInfo/index.html\">SpellInfo</a>."],
        [3, "GetSpellLevel", "", "Returns the spell level of the <a class=\"mod\" href=\"SpellInfo/index.html\">SpellInfo</a>."],
        [3, "GetSpellMechanicMaskByEffectMask", "", "Returns the mechanic mask for the given effect mask of the <a class=\"mod\" href=\"SpellInfo/index.html\">SpellInfo</a>."],
        [3, "GetSpellSpecific", "", "Returns the spell specific type of the <a class=\"mod\" href=\"SpellInfo/index.html\">SpellInfo</a>."],
        [3, "GetSpellVisual", "", "Returns the spell visual ID at the given index for the <a class=\"mod\" href=\"SpellInfo/index.html\">SpellInfo</a>."],
        [3, "GetStackAmount", "", "Returns the stack amount of the <a class=\"mod\" href=\"SpellInfo/index.html\">SpellInfo</a>."],
        [3, "GetStances", "", "Returns the stances bitmask of the <a class=\"mod\" href=\"SpellInfo/index.html\">SpellInfo</a> as uint32."],
        [3, "GetStancesNot", "", "Returns the stances not bitmask of the <a class=\"mod\" href=\"SpellInfo/index.html\">SpellInfo</a> as uint32."],
        [3, "GetStartRecoveryCategory", "", "Returns the start recovery category of the <a class=\"mod\" href=\"SpellInfo/index.html\">SpellInfo</a>."],
        [3, "GetStartRecoveryTime", "", "Returns the start recovery time in milliseconds of the <a class=\"mod\" href=\"SpellInfo/index.html\">SpellInfo</a>."],
        [3, "GetTargetAuraSpell", "", "Returns the spell ID that must be active on the target to cast the <a class=\"mod\" href=\"SpellInfo/index.html\">SpellInfo</a>."],
        [3, "GetTargetAuraState", "", "Returns the target aura state required to cast the <a class=\"mod\" href=\"SpellInfo/index.html\">SpellInfo</a>."],
        [3, "GetTargetAuraStateNot", "", "Returns the target aura state that prevents casting the <a class=\"mod\" href=\"SpellInfo/index.html\">SpellInfo</a>."],
        [3, "GetTargetCreatureType", "", "Returns the target creature type of the <a class=\"mod\" href=\"SpellInfo/index.html\">SpellInfo</a>."],
        [3, "GetTargets", "", "Returns the targets bitmask of the <a class=\"mod\" href=\"SpellInfo/index.html\">SpellInfo</a>."],
        [3, "GetTotem", "", "Returns the totem entry at the given index for the <a class=\"mod\" href=\"SpellInfo/index.html\">SpellInfo</a>."],
        [3, "GetTotemCategory", "", "Returns the totem category entry at the given index for the <a class=\"mod\" href=\"SpellInfo/index.html\">SpellInfo</a>."],
        [3, "HasAreaAuraEffect", "", "Returns <code>true</code> if the <a class=\"mod\" href=\"SpellInfo/index.html\">SpellInfo</a> has an area aura effect, <code>false</code> otherwise."],
        [3, "HasAura", "", "Returns <code>true</code> if the <a class=\"mod\" href=\"SpellInfo/index.html\">SpellInfo</a> has the given aura type, <code>false</code> otherwise."],
        [3, "HasEffect", "", "Returns <code>true</code> if the <a class=\"mod\" href=\"SpellInfo/index.html\">SpellInfo</a> has the given spell effect, <code>false</code> otherwise."],
        [3, "HasInitialAggro", "", "Returns <code>true</code> if the <a class=\"mod\" href=\"SpellInfo/index.html\">SpellInfo</a> has initial aggro, <code>false</code> otherwise."],
        [3, "HasOnlyDamageEffects", "", "Returns <code>true</code> if the <a class=\"mod\" href=\"SpellInfo/index.html\">SpellInfo</a> only has damage effects, <code>false</code> otherwise."],
        [3, "IsAbilityLearnedWithProfession", "", "Returns <code>true</code> if the <a class=\"mod\" href=\"SpellInfo/index.html\">SpellInfo</a> is an ability learned with a profession, <code>false</code> otherwise."],
        [3, "IsAbilityOfSkillType", "", "Returns <code>true</code> if the <a class=\"mod\" href=\"SpellInfo/index.html\">SpellInfo</a> is an ability of the given skill type, <code>false</code> otherwise."],
        [3, "IsAffected", "", "Returns <code>true</code> if the <a class=\"mod\" href=\"SpellInfo/index.html\">SpellInfo</a> is affected by the given spell family and flags, <code>false</code> otherwise. The flags are a 96-bit value split into three uint32 components."],
        [3, "IsAffectedBySpellMod", "", "Returns <code>true</code> if the <a class=\"mod\" href=\"SpellInfo/index.html\">SpellInfo</a> is affected by the given [SpellModifier], <code>false</code> otherwise."],
        [3, "IsAffectedBySpellMods", "", "Returns <code>true</code> if the <a class=\"mod\" href=\"SpellInfo/index.html\">SpellInfo</a> is affected by spell mods, <code>false</code> otherwise."],
        [3, "IsAffectingArea", "", "Returns <code>true</code> if the <a class=\"mod\" href=\"SpellInfo/index.html\">SpellInfo</a> affects an area, <code>false</code> otherwise."],
        [3, "IsAllowingDeadTarget", "", "Returns <code>true</code> if the <a class=\"mod\" href=\"SpellInfo/index.html\">SpellInfo</a> allows targeting dead units, <code>false</code> otherwise."],
        [3, "IsAuraExclusiveBySpecificPerCasterWith", "", "Returns <code>true</code> if the <a class=\"mod\" href=\"SpellInfo/index.html\">SpellInfo</a> is exclusively stacking per caster with the given <a class=\"mod\" href=\"SpellInfo/index.html\">SpellInfo</a> by specific aura, <code>false</code> otherwise."],
        [3, "IsAuraExclusiveBySpecificWith", "", "Returns <code>true</code> if the <a class=\"mod\" href=\"SpellInfo/index.html\">SpellInfo</a> is exclusively stacking with the given <a class=\"mod\" href=\"SpellInfo/index.html\">SpellInfo</a> by specific aura, <code>false</code> otherwise."],
        [3, "IsAutoRepeatRangedSpell", "", "Returns <code>true</code> if the <a class=\"mod\" href=\"SpellInfo/index.html\">SpellInfo</a> is an auto repeat ranged spell, <code>false</code> otherwise."],
        [3, "IsAutocastable", "", "Returns <code>true</code> if the <a class=\"mod\" href=\"SpellInfo/index.html\">SpellInfo</a> is autocastable, <code>false</code> otherwise."],
        [3, "IsBreakingStealth", "", "Returns <code>true</code> if the <a class=\"mod\" href=\"SpellInfo/index.html\">SpellInfo</a> breaks stealth, <code>false</code> otherwise."],
        [3, "IsChanneled", "", "Returns <code>true</code> if the <a class=\"mod\" href=\"SpellInfo/index.html\">SpellInfo</a> is a channeled spell, <code>false</code> otherwise."],
        [3, "IsCooldownStartedOnEvent", "", "Returns <code>true</code> if the <a class=\"mod\" href=\"SpellInfo/index.html\">SpellInfo</a> cooldown is started on event, <code>false</code> otherwise."],
        [3, "IsDeathPersistent", "", "Returns <code>true</code> if the <a class=\"mod\" href=\"SpellInfo/index.html\">SpellInfo</a> persists through death, <code>false</code> otherwise."],
        [3, "IsDifferentRankOf", "", "Returns <code>true</code> if the <a class=\"mod\" href=\"SpellInfo/index.html\">SpellInfo</a> is a different rank of the given <a class=\"mod\" href=\"SpellInfo/index.html\">SpellInfo</a>, <code>false</code> otherwise."],
        [3, "IsExplicitDiscovery", "", "Returns <code>true</code> if the <a class=\"mod\" href=\"SpellInfo/index.html\">SpellInfo</a> is an explicit discovery spell, <code>false</code> otherwise."],
        [3, "IsGroupBuff", "", "Returns <code>true</code> if the <a class=\"mod\" href=\"SpellInfo/index.html\">SpellInfo</a> is a group buff, <code>false</code> otherwise."],
        [3, "IsHighRankOf", "", "Returns <code>true</code> if the <a class=\"mod\" href=\"SpellInfo/index.html\">SpellInfo</a> is a higher rank than the given <a class=\"mod\" href=\"SpellInfo/index.html\">SpellInfo</a>, <code>false</code> otherwise."],
        [3, "IsItemFitToSpellRequirements", "", "Returns <code>true</code> if the given <a class=\"mod\" href=\"Item/index.html\">Item</a> fits the requirements of the <a class=\"mod\" href=\"SpellInfo/index.html\">SpellInfo</a>, <code>false</code> otherwise."],
        [3, "IsLootCrafting", "", "Returns <code>true</code> if the <a class=\"mod\" href=\"SpellInfo/index.html\">SpellInfo</a> is a loot crafting spell, <code>false</code> otherwise."],
        [3, "IsMoveAllowedChannel", "", "Returns <code>true</code> if the <a class=\"mod\" href=\"SpellInfo/index.html\">SpellInfo</a> allows movement while channeling, <code>false</code> otherwise."],
        [3, "IsMultiSlotAura", "", "Returns <code>true</code> if the <a class=\"mod\" href=\"SpellInfo/index.html\">SpellInfo</a> occupies multiple aura slots, <code>false</code> otherwise."],
        [3, "IsNextMeleeSwingSpell", "", "Returns <code>true</code> if the <a class=\"mod\" href=\"SpellInfo/index.html\">SpellInfo</a> is a next melee swing spell, <code>false</code> otherwise."],
        [3, "IsPassive", "", "Returns <code>true</code> if the <a class=\"mod\" href=\"SpellInfo/index.html\">SpellInfo</a> is a passive spell, <code>false</code> otherwise."],
        [3, "IsPassiveStackableWithRanks", "", "Returns <code>true</code> if the <a class=\"mod\" href=\"SpellInfo/index.html\">SpellInfo</a> is a passive spell stackable with ranks, <code>false</code> otherwise."],
        [3, "IsPositive", "", "Returns <code>true</code> if the <a class=\"mod\" href=\"SpellInfo/index.html\">SpellInfo</a> is a positive spell, <code>false</code> otherwise."],
        [3, "IsPositiveEffect", "", "Returns <code>true</code> if the effect at the given index of the <a class=\"mod\" href=\"SpellInfo/index.html\">SpellInfo</a> is positive, <code>false</code> otherwise."],
        [3, "IsPrimaryProfession", "", "Returns <code>true</code> if the <a class=\"mod\" href=\"SpellInfo/index.html\">SpellInfo</a> is a primary profession spell, <code>false</code> otherwise."],
        [3, "IsPrimaryProfessionFirstRank", "", "Returns <code>true</code> if the <a class=\"mod\" href=\"SpellInfo/index.html\">SpellInfo</a> is the first rank of a primary profession spell, <code>false</code> otherwise."],
        [3, "IsProfession", "", "Returns <code>true</code> if the <a class=\"mod\" href=\"SpellInfo/index.html\">SpellInfo</a> is a profession spell, <code>false</code> otherwise."],
        [3, "IsProfessionOrRiding", "", "Returns <code>true</code> if the <a class=\"mod\" href=\"SpellInfo/index.html\">SpellInfo</a> is a profession or riding spell, <code>false</code> otherwise."],
        [3, "IsRangedWeaponSpell", "", "Returns <code>true</code> if the <a class=\"mod\" href=\"SpellInfo/index.html\">SpellInfo</a> is a ranged weapon spell, <code>false</code> otherwise."],
        [3, "IsRankOf", "", "Returns <code>true</code> if the <a class=\"mod\" href=\"SpellInfo/index.html\">SpellInfo</a> is the same rank as the given <a class=\"mod\" href=\"SpellInfo/index.html\">SpellInfo</a>, <code>false</code> otherwise."],
        [3, "IsRanked", "", "Returns <code>true</code> if the <a class=\"mod\" href=\"SpellInfo/index.html\">SpellInfo</a> is ranked, <code>false</code> otherwise."],
        [3, "IsRequiringDeadTarget", "", "Returns <code>true</code> if the <a class=\"mod\" href=\"SpellInfo/index.html\">SpellInfo</a> requires the target to be dead, <code>false</code> otherwise."],
        [3, "IsSelfCast", "", "Returns <code>true</code> if the <a class=\"mod\" href=\"SpellInfo/index.html\">SpellInfo</a> is a self cast spell, <code>false</code> otherwise."],
        [3, "IsSingleTarget", "", "Returns <code>true</code> if the <a class=\"mod\" href=\"SpellInfo/index.html\">SpellInfo</a> can only have a single target active at a time, <code>false</code> otherwise."],
        [3, "IsStackableOnOneSlotWithDifferentCasters", "", "Returns <code>true</code> if the <a class=\"mod\" href=\"SpellInfo/index.html\">SpellInfo</a> can stack on one slot from different casters, <code>false</code> otherwise."],
        [3, "IsStackableWithRanks", "", "Returns <code>true</code> if the <a class=\"mod\" href=\"SpellInfo/index.html\">SpellInfo</a> is stackable with ranks, <code>false</code> otherwise."],
        [3, "IsTargetingArea", "", "Returns <code>true</code> if the <a class=\"mod\" href=\"SpellInfo/index.html\">SpellInfo</a> targets an area, <code>false</code> otherwise."],
        [3, "NeedsComboPoints", "", "Returns <code>true</code> if the <a class=\"mod\" href=\"SpellInfo/index.html\">SpellInfo</a> requires combo points, <code>false</code> otherwise."],
        [3, "NeedsExplicitUnitTarget", "", "Returns <code>true</code> if the <a class=\"mod\" href=\"SpellInfo/index.html\">SpellInfo</a> needs an explicit unit target, <code>false</code> otherwise."],
        [3, "NeedsToBeTriggeredByCaster", "", "Returns <code>true</code> if the <a class=\"mod\" href=\"SpellInfo/index.html\">SpellInfo</a> needs to be triggered by the given triggering <a class=\"mod\" href=\"SpellInfo/index.html\">SpellInfo</a>, <code>false</code> otherwise."],
        [3, "SpellCancelsAuraEffect", "", "Returns <code>true</code> if the <a class=\"mod\" href=\"SpellInfo/index.html\">SpellInfo</a> cancels the given <a class=\"mod\" href=\"AuraEffect/index.html\">AuraEffect</a>, <code>false</code> otherwise."],
    ],
    "paths": []
};searchIndex["Unit"] = {
    "items": [
        ...
        [3, "DisableMelee", "", "Enables or disables whether or not the <a class=\"mod\" href=\"Unit/index.html\">Unit</a> can melee auto attack."],
        ...
        [3, "GetAura", "", "Returns the <a class=\"mod\" href=\"Aura/index.html\">Aura</a> of the given spell on the <a class=\"mod\" href=\"Unit/index.html\">Unit</a>, or nil if not found. Optionally filters by caster, item caster, and required effect mask."],
        ...
        [3, "GetOwnedAura", "", "Returns the owned <a class=\"mod\" href=\"Aura/index.html\">Aura</a> of the given spell on the <a class=\"mod\" href=\"Unit/index.html\">Unit</a>, or nil if not found. Similar to GetAura but searches owned auras and optionally excludes a specific <a class=\"mod\" href=\"Aura/index.html\">Aura</a>."],
        ...
        [3, "GetVehicle", "", "Returns <a class=\"mod\" href=\"Unit/index.html\">Unit</a>'s <a class=\"mod\" href=\"Vehicle/index.html\">Vehicle</a> object"],
        ...
        [3, "RemoveBindSightAuras", "", "Removes all bind sight auras from the <a class=\"mod\" href=\"Unit/index.html\">Unit</a>."],
        [3, "RemoveCharmAuras", "", "Removes all charm auras from the <a class=\"mod\" href=\"Unit/index.html\">Unit</a>."],
        [3, "RestoreDisplayId", "", "Restores the <a class=\"mod\" href=\"Unit/index.html\">Unit</a>s display ID to default"],
        [3, "RestoreFaction", "", "Restores the <a class=\"mod\" href=\"Unit/index.html\">Unit</a>s faction to default"],
        ...
        [3, "SetCanFly", "", "Sets whether or not the <a class=\"mod\" href=\"Unit/index.html\">Unit</a> can fly."],
        ...
        [3, "SetCritterGUID", "", "Sets the <a class=\"mod\" href=\"Unit/index.html\">Unit</a>s critter GUID field."],
        ...
        [3, "SetStunned", "", "Sets whether or not the <a class=\"mod\" href=\"Unit/index.html\">Unit</a> is stunned."],
        [3, "SetVisible", "", "Sets whether or not the <a class=\"mod\" href=\"Unit/index.html\">Unit</a> is visible."],
