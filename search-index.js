...
searchIndex["Aura"] = {
    ...
    "items": [
        ...
        [3, "AuthDBExecute", "", "Executes a [Query] (not instantly ) to your auth database"],
        [3, "AuthDBQuery", "", "Executes auth database sql [Query] instantly and returns QueryResult object"],
        [3, "Ban", "", "Ban's a <a class=\"mod\" href=\"Player/index.html\">Player</a>'s account, character or IP"],
        [3, "CharDBExecute", "", "Executes a [Query] (not instantly) to your character database"],
        [3, "CharDBQuery", "", "Executes character database sql [Query] instantly and returns QueryResult object"],
        ...
        [3, "WorldDBExecute", "", "Executes a sql [Query] (not instantly) to your world database"],
        [3, "WorldDBQuery", "", "Executes world database sql [Query] instantly and returns QueryResult object"],
