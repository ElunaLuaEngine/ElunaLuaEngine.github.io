...
searchIndex["Aura"] = {
    "items": [
        ...
        [3, "GetSpellInfo", "", "Returns the [ElunaSpellInfo] of the spell that created this <a class=\"mod\" href=\"Aura/index.html\">Aura</a>."],
    ...
    "items": [
        ...
        [3, "GetSpellInfo", "", "Returns the [ElunaSpellInfo] for the given spell ID, or nil if the spell does not exist."],
    ...
    "items": [
        [0, "", "SpellInfo", ""],
        [3, "CalcCastTime", "", "Returns the calculated cast time in milliseconds of the [ElunaSpellInfo]."],
        [3, "CanBeUsedInCombat", "", "Returns <code>true</code> if the [ElunaSpellInfo] can be used in combat, <code>false</code> otherwise."],
        [3, "CanDispelAura", "", "Returns <code>true</code> if the [ElunaSpellInfo] can dispel the given [ElunaSpellInfo], <code>false</code> otherwise."],
        [3, "CanPierceImmuneAura", "", "Returns <code>true</code> if the [ElunaSpellInfo] can pierce the immunity provided by the given [ElunaSpellInfo], <code>false</code> otherwise."],
        [3, "CanSpellProvideImmunityAgainstAura", "", "Returns <code>true</code> if the [ElunaSpellInfo] can provide immunity against the given [ElunaSpellInfo], <code>false</code> otherwise."],
        [3, "CheckTarget", "", "Checks whether the [ElunaSpellInfo] can be cast on the given target by the given caster. Returns the [SpellCastResult] of the check."],
        [3, "CheckTargetCreatureType", "", "Returns <code>true</code> if the given <a class=\"mod\" href=\"Unit/index.html\">Unit</a> matches the required creature type for the [ElunaSpellInfo], <code>false</code> otherwise."],
        [3, "EffectIsAreaAuraEffect", "", "Returns <code>true</code> if the given effect slot of the [ElunaSpellInfo] is an area aura effect, <code>false</code> otherwise."],
        [3, "EffectIsAura", "", "Returns <code>true</code> if the given effect slot of the [ElunaSpellInfo] applies an aura, <code>false</code> otherwise."],
        [3, "EffectIsAuraType", "", "Returns <code>true</code> if the given effect slot of the [ElunaSpellInfo] applies the given aura type, <code>false</code> otherwise."],
        [3, "EffectIsEffect", "", "Returns <code>true</code> if the given effect slot of the [ElunaSpellInfo] is an effect, <code>false</code> otherwise."],
        [3, "EffectIsEffectType", "", "Returns <code>true</code> if the given effect slot of the [ElunaSpellInfo] is the given effect type, <code>false</code> otherwise."],
        [3, "EffectIsTargetingArea", "", "Returns <code>true</code> if the given effect slot of the [ElunaSpellInfo] is targeting an area, <code>false</code> otherwise."],
        [3, "EffectIsUnitOwnedAuraEffect", "", "Returns <code>true</code> if the given effect slot of the [ElunaSpellInfo] is a unit owned aura effect, <code>false</code> otherwise."],
        [3, "GetActiveIconID", "", "Returns the active icon ID of the [ElunaSpellInfo]."],
        [3, "GetAllEffectsMechanicMask", "", "Returns a bitmask of all mechanics used across all effects of the [ElunaSpellInfo]."],
        [3, "GetAllowedMechanicMask", "", "Returns the allowed mechanic mask of the [ElunaSpellInfo]."],
        [3, "GetAreaGroupId", "", "Returns the area group ID of the [ElunaSpellInfo]."],
        [3, "GetAttackType", "", "Returns the weapon attack type of the [ElunaSpellInfo]."],
        [3, "GetAttributes", "", "Returns the attributes of the [ElunaSpellInfo]."],
        [3, "GetAttributesCu", "", "Returns the custom attributes of the [ElunaSpellInfo]."],
        [3, "GetAttributesEx", "", "Returns the first extended attributes of the [ElunaSpellInfo]."],
        [3, "GetAttributesEx2", "", "Returns the second extended attributes of the [ElunaSpellInfo]."],
        [3, "GetAttributesEx3", "", "Returns the third extended attributes of the [ElunaSpellInfo]."],
        [3, "GetAttributesEx4", "", "Returns the fourth extended attributes of the [ElunaSpellInfo]."],
        [3, "GetAttributesEx5", "", "Returns the fifth extended attributes of the [ElunaSpellInfo]."],
        [3, "GetAttributesEx6", "", "Returns the sixth extended attributes of the [ElunaSpellInfo]."],
        [3, "GetAttributesEx7", "", "Returns the seventh extended attributes of the [ElunaSpellInfo]."],
        [3, "GetAuraInterruptFlags", "", "Returns the aura interrupt flags of the [ElunaSpellInfo]."],
        [3, "GetAuraState", "", "Returns the aura state of the [ElunaSpellInfo]."],
        [3, "GetBaseLevel", "", "Returns the base level required to cast the [ElunaSpellInfo]."],
        [3, "GetCasterAuraSpell", "", "Returns the spell ID that must be active on the caster to cast the [ElunaSpellInfo]."],
        [3, "GetCasterAuraState", "", "Returns the caster aura state required to cast the [ElunaSpellInfo]."],
        [3, "GetCasterAuraStateNot", "", "Returns the caster aura state that prevents casting the [ElunaSpellInfo]."],
        [3, "GetCategory", "", "Returns the category of the [ElunaSpellInfo]."],
        [3, "GetCategoryRecoveryTime", "", "Returns the category recovery time in milliseconds of the [ElunaSpellInfo]."],
        [3, "GetChannelInterruptFlags", "", "Returns the channel interrupt flags of the [ElunaSpellInfo]."],
        [3, "GetDiminishingReturnsGroupForSpell", "", "Returns the diminishing returns group for the [ElunaSpellInfo]."],
        [3, "GetDiminishingReturnsGroupType", "", "Returns the diminishing returns group type for the [ElunaSpellInfo]."],
        [3, "GetDiminishingReturnsLimitDuration", "", "Returns the diminishing returns limit duration in milliseconds for the [ElunaSpellInfo]."],
        [3, "GetDiminishingReturnsMaxLevel", "", "Returns the diminishing returns max level for the [ElunaSpellInfo]."],
        [3, "GetDispel", "", "Returns the dispel type of the [ElunaSpellInfo]."],
        [3, "GetDmgClass", "", "Returns the damage class of the [ElunaSpellInfo]."],
        [3, "GetDuration", "", "Returns the duration in milliseconds of the [ElunaSpellInfo]."],
        [3, "GetEffectAmplitude", "", "Returns the amplitude in milliseconds of the given effect slot of the [ElunaSpellInfo]."],
        [3, "GetEffectApplyAuraName", "", "Returns the aura type applied by the given effect slot of the [ElunaSpellInfo]."],
        [3, "GetEffectBasePoints", "", "Returns the base points of the given effect slot of the [ElunaSpellInfo]."],
        [3, "GetEffectBonusMultiplier", "", "Returns the bonus multiplier of the given effect slot of the [ElunaSpellInfo]."],
        [3, "GetEffectCalcRadius", "", "Returns the calculated radius for the given effect slot of the [ElunaSpellInfo]."],
        [3, "GetEffectCalcValue", "", "Returns the calculated value for the given effect slot of the [ElunaSpellInfo]."],
        [3, "GetEffectChainTarget", "", "Returns the chain target count of the given effect slot of the [ElunaSpellInfo]."],
        [3, "GetEffectDamageMultiplier", "", "Returns the damage multiplier of the given effect slot of the [ElunaSpellInfo]."],
        [3, "GetEffectDieSides", "", "Returns the die sides of the given effect slot of the [ElunaSpellInfo]."],
        [3, "GetEffectHasRadius", "", "Returns <code>true</code> if the given effect slot of the [ElunaSpellInfo] has a radius, <code>false</code> otherwise."],
        [3, "GetEffectImplicitTargetType", "", "Returns the implicit target type for the given effect slot of the [ElunaSpellInfo]."],
        [3, "GetEffectIndex", "", "Returns the effect index of the given effect slot of the [ElunaSpellInfo]."],
        [3, "GetEffectItemType", "", "Returns the item type entry of the given effect slot of the [ElunaSpellInfo]."],
        [3, "GetEffectMechanic", "", "Returns the mechanic for the given effect index of the [ElunaSpellInfo]."],
        [3, "GetEffectMechanicMask", "", "Returns the mechanic mask for the given effect index of the [ElunaSpellInfo]."],
        [3, "GetEffectMiscValue", "", "Returns the misc value of the given effect slot of the [ElunaSpellInfo]."],
        [3, "GetEffectMiscValueB", "", "Returns the secondary misc value of the given effect slot of the [ElunaSpellInfo]."],
        [3, "GetEffectPointsPerComboPoint", "", "Returns the points per combo point of the given effect slot of the [ElunaSpellInfo]."],
        [3, "GetEffectProvidedTargetMask", "", "Returns the provided target mask for the given effect slot of the [ElunaSpellInfo]."],
        [3, "GetEffectRealPointsPerLevel", "", "Returns the real points per level of the given effect slot of the [ElunaSpellInfo]."],
        [3, "GetEffectSpellClassMask", "", "Returns the spell class mask component at the given mask index for the given effect slot of the [ElunaSpellInfo]. The mask is a 96-bit value split into three uint32 components (index 0-2)."],
        [3, "GetEffectTargetACheckType", "", "Returns the target A check type of the given effect slot of the [ElunaSpellInfo]."],
        [3, "GetEffectTargetADirectionAngle", "", "Returns the calculated direction angle for target A of the given effect slot of the [ElunaSpellInfo]."],
        [3, "GetEffectTargetADirectionType", "", "Returns the target A direction type of the given effect slot of the [ElunaSpellInfo]."],
        [3, "GetEffectTargetAIsArea", "", "Returns <code>true</code> if target A of the given effect slot of the [ElunaSpellInfo] is an area target, <code>false</code> otherwise."],
        [3, "GetEffectTargetAObjectType", "", "Returns the target A object type of the given effect slot of the [ElunaSpellInfo]."],
        [3, "GetEffectTargetAReferenceType", "", "Returns the target A reference type of the given effect slot of the [ElunaSpellInfo]."],
        [3, "GetEffectTargetASelectionCategory", "", "Returns the target A selection category of the given effect slot of the [ElunaSpellInfo]."],
        [3, "GetEffectTargetATarget", "", "Returns the target A type of the given effect slot of the [ElunaSpellInfo]."],
        [3, "GetEffectTargetBCheckType", "", "Returns the target B check type of the given effect slot of the [ElunaSpellInfo]."],
        [3, "GetEffectTargetBDirectionAngle", "", "Returns the calculated direction angle for target B of the given effect slot of the [ElunaSpellInfo]."],
        [3, "GetEffectTargetBDirectionType", "", "Returns the target B direction type of the given effect slot of the [ElunaSpellInfo]."],
        [3, "GetEffectTargetBIsArea", "", "Returns <code>true</code> if target B of the given effect slot of the [ElunaSpellInfo] is an area target, <code>false</code> otherwise."],
        [3, "GetEffectTargetBObjectType", "", "Returns the target B object type of the given effect slot of the [ElunaSpellInfo]."],
        [3, "GetEffectTargetBReferenceType", "", "Returns the target B reference type of the given effect slot of the [ElunaSpellInfo]."],
        [3, "GetEffectTargetBSelectionCategory", "", "Returns the target B selection category of the given effect slot of the [ElunaSpellInfo]."],
        [3, "GetEffectTargetBTarget", "", "Returns the target B type of the given effect slot of the [ElunaSpellInfo]."],
        [3, "GetEffectTriggerSpell", "", "Returns the trigger spell ID of the given effect slot of the [ElunaSpellInfo]."],
        [3, "GetEffectType", "", "Returns the effect type of the given effect slot of the [ElunaSpellInfo]."],
        [3, "GetEffectUsedTargetObjectType", "", "Returns the used target object type for the given effect slot of the [ElunaSpellInfo]."],
        [3, "GetEffectValueMultiplier", "", "Returns the value multiplier of the given effect slot of the [ElunaSpellInfo]."],
        [3, "GetEquippedItemClass", "", "Returns the required equipped item class of the [ElunaSpellInfo]."],
        [3, "GetEquippedItemInventoryTypeMask", "", "Returns the required equipped item inventory type mask of the [ElunaSpellInfo]."],
        [3, "GetEquippedItemSubClassMask", "", "Returns the required equipped item subclass mask of the [ElunaSpellInfo]."],
        [3, "GetExcludeCasterAuraSpell", "", "Returns the spell ID that must not be active on the caster to cast the [ElunaSpellInfo]."],
        [3, "GetExcludeTargetAuraSpell", "", "Returns the spell ID that must not be active on the target to cast the [ElunaSpellInfo]."],
        [3, "GetExplicitTargetMask", "", "Returns the explicit target mask of the [ElunaSpellInfo]."],
        [3, "GetFacingCasterFlags", "", "Returns the facing caster flags of the [ElunaSpellInfo]."],
        [3, "GetId", "", "Returns the ID of the [ElunaSpellInfo]."],
        [3, "GetInterruptFlags", "", "Returns the interrupt flags of the [ElunaSpellInfo]."],
        [3, "GetManaCost", "", "Returns the mana cost of the [ElunaSpellInfo]."],
        [3, "GetManaCostPercentage", "", "Returns the mana cost percentage of the [ElunaSpellInfo]."],
        [3, "GetManaCostPerlevel", "", "Returns the mana cost per level of the [ElunaSpellInfo]."],
        [3, "GetManaPerSecond", "", "Returns the mana per second drain of the [ElunaSpellInfo]."],
        [3, "GetManaPerSecondPerLevel", "", "Returns the mana per second per level drain of the [ElunaSpellInfo]."],
        [3, "GetMaxAffectedTargets", "", "Returns the maximum number of affected targets of the [ElunaSpellInfo]."],
        [3, "GetMaxDuration", "", "Returns the maximum duration in milliseconds of the [ElunaSpellInfo]."],
        [3, "GetMaxLevel", "", "Returns the maximum level of the [ElunaSpellInfo]."],
        [3, "GetMaxRange", "", "Returns the maximum range of the [ElunaSpellInfo]."],
        [3, "GetMaxTargetLevel", "", "Returns the maximum target level of the [ElunaSpellInfo]."],
        [3, "GetMaxTicks", "", "Returns the maximum number of ticks of the [ElunaSpellInfo]."],
        [3, "GetMechanic", "", "Returns the mechanic of the [ElunaSpellInfo]."],
        [3, "GetMinRange", "", "Returns the minimum range of the [ElunaSpellInfo]."],
        [3, "GetPowerType", "", "Returns the power type of the [ElunaSpellInfo]."],
        [3, "GetPreventionType", "", "Returns the prevention type of the [ElunaSpellInfo]."],
        [3, "GetPriority", "", "Returns the priority of the [ElunaSpellInfo]."],
        [3, "GetProcChance", "", "Returns the proc chance of the [ElunaSpellInfo]."],
        [3, "GetProcCharges", "", "Returns the proc charges of the [ElunaSpellInfo]."],
        [3, "GetProcFlags", "", "Returns the proc flags of the [ElunaSpellInfo]."],
        [3, "GetRank", "", "Returns the rank of the [ElunaSpellInfo]."],
        [3, "GetReagent", "", "Returns the reagent entry at the given index for the [ElunaSpellInfo]."],
        [3, "GetReagentCount", "", "Returns the reagent count at the given index for the [ElunaSpellInfo]."],
        [3, "GetRecoveryTime", "", "Returns the recovery time in milliseconds of the [ElunaSpellInfo]."],
        [3, "GetRequiresSpellFocus", "", "Returns the requires spell focus entry of the [ElunaSpellInfo]."],
        [3, "GetRuneCostID", "", "Returns the rune cost ID of the [ElunaSpellInfo]."],
        [3, "GetSchoolMask", "", "Returns the school mask of the [ElunaSpellInfo]."],
        [3, "GetSpeed", "", "Returns the projectile speed of the [ElunaSpellInfo]."],
        [3, "GetSpellFamilyFlags", "", "Returns the spell family flags of the [ElunaSpellInfo] at the given index. The flags are a 96-bit value split into three uint32 components (index 0-2)."],
        [3, "GetSpellFamilyName", "", "Returns the spell family name of the [ElunaSpellInfo]."],
        [3, "GetSpellIconID", "", "Returns the spell icon ID of the [ElunaSpellInfo]."],
        [3, "GetSpellLevel", "", "Returns the spell level of the [ElunaSpellInfo]."],
        [3, "GetSpellMechanicMaskByEffectMask", "", "Returns the mechanic mask for the given effect mask of the [ElunaSpellInfo]."],
        [3, "GetSpellSpecific", "", "Returns the spell specific type of the [ElunaSpellInfo]."],
        [3, "GetSpellVisual", "", "Returns the spell visual ID at the given index for the [ElunaSpellInfo]."],
        [3, "GetStackAmount", "", "Returns the stack amount of the [ElunaSpellInfo]."],
        [3, "GetStances", "", "Returns the stances bitmask of the [ElunaSpellInfo] as uint32."],
        [3, "GetStancesNot", "", "Returns the stances not bitmask of the [ElunaSpellInfo] as uint32."],
        [3, "GetStartRecoveryCategory", "", "Returns the start recovery category of the [ElunaSpellInfo]."],
        [3, "GetStartRecoveryTime", "", "Returns the start recovery time in milliseconds of the [ElunaSpellInfo]."],
        [3, "GetTargetAuraSpell", "", "Returns the spell ID that must be active on the target to cast the [ElunaSpellInfo]."],
        [3, "GetTargetAuraState", "", "Returns the target aura state required to cast the [ElunaSpellInfo]."],
        [3, "GetTargetAuraStateNot", "", "Returns the target aura state that prevents casting the [ElunaSpellInfo]."],
        [3, "GetTargetCreatureType", "", "Returns the target creature type of the [ElunaSpellInfo]."],
        [3, "GetTargets", "", "Returns the targets bitmask of the [ElunaSpellInfo]."],
        [3, "GetTotem", "", "Returns the totem entry at the given index for the [ElunaSpellInfo]."],
        [3, "GetTotemCategory", "", "Returns the totem category entry at the given index for the [ElunaSpellInfo]."],
        [3, "HasAreaAuraEffect", "", "Returns <code>true</code> if the [ElunaSpellInfo] has an area aura effect, <code>false</code> otherwise."],
        [3, "HasAura", "", "Returns <code>true</code> if the [ElunaSpellInfo] has the given aura type, <code>false</code> otherwise."],
        [3, "HasEffect", "", "Returns <code>true</code> if the [ElunaSpellInfo] has the given spell effect, <code>false</code> otherwise."],
        [3, "HasInitialAggro", "", "Returns <code>true</code> if the [ElunaSpellInfo] has initial aggro, <code>false</code> otherwise."],
        [3, "HasOnlyDamageEffects", "", "Returns <code>true</code> if the [ElunaSpellInfo] only has damage effects, <code>false</code> otherwise."],
        [3, "IsAbilityLearnedWithProfession", "", "Returns <code>true</code> if the [ElunaSpellInfo] is an ability learned with a profession, <code>false</code> otherwise."],
        [3, "IsAbilityOfSkillType", "", "Returns <code>true</code> if the [ElunaSpellInfo] is an ability of the given skill type, <code>false</code> otherwise."],
        [3, "IsAffected", "", "Returns <code>true</code> if the [ElunaSpellInfo] is affected by the given spell family and flags, <code>false</code> otherwise. The flags are a 96-bit value split into three uint32 components."],
        [3, "IsAffectedBySpellMod", "", "Returns <code>true</code> if the [ElunaSpellInfo] is affected by the given [SpellModifier], <code>false</code> otherwise."],
        [3, "IsAffectedBySpellMods", "", "Returns <code>true</code> if the [ElunaSpellInfo] is affected by spell mods, <code>false</code> otherwise."],
        [3, "IsAffectingArea", "", "Returns <code>true</code> if the [ElunaSpellInfo] affects an area, <code>false</code> otherwise."],
        [3, "IsAllowingDeadTarget", "", "Returns <code>true</code> if the [ElunaSpellInfo] allows targeting dead units, <code>false</code> otherwise."],
        [3, "IsAuraExclusiveBySpecificPerCasterWith", "", "Returns <code>true</code> if the [ElunaSpellInfo] is exclusively stacking per caster with the given [ElunaSpellInfo] by specific aura, <code>false</code> otherwise."],
        [3, "IsAuraExclusiveBySpecificWith", "", "Returns <code>true</code> if the [ElunaSpellInfo] is exclusively stacking with the given [ElunaSpellInfo] by specific aura, <code>false</code> otherwise."],
        [3, "IsAutoRepeatRangedSpell", "", "Returns <code>true</code> if the [ElunaSpellInfo] is an auto repeat ranged spell, <code>false</code> otherwise."],
        [3, "IsAutocastable", "", "Returns <code>true</code> if the [ElunaSpellInfo] is autocastable, <code>false</code> otherwise."],
        [3, "IsBreakingStealth", "", "Returns <code>true</code> if the [ElunaSpellInfo] breaks stealth, <code>false</code> otherwise."],
        [3, "IsChanneled", "", "Returns <code>true</code> if the [ElunaSpellInfo] is a channeled spell, <code>false</code> otherwise."],
        [3, "IsCooldownStartedOnEvent", "", "Returns <code>true</code> if the [ElunaSpellInfo] cooldown is started on event, <code>false</code> otherwise."],
        [3, "IsDeathPersistent", "", "Returns <code>true</code> if the [ElunaSpellInfo] persists through death, <code>false</code> otherwise."],
        [3, "IsDifferentRankOf", "", "Returns <code>true</code> if the [ElunaSpellInfo] is a different rank of the given [ElunaSpellInfo], <code>false</code> otherwise."],
        [3, "IsExplicitDiscovery", "", "Returns <code>true</code> if the [ElunaSpellInfo] is an explicit discovery spell, <code>false</code> otherwise."],
        [3, "IsGroupBuff", "", "Returns <code>true</code> if the [ElunaSpellInfo] is a group buff, <code>false</code> otherwise."],
        [3, "IsHighRankOf", "", "Returns <code>true</code> if the [ElunaSpellInfo] is a higher rank than the given [ElunaSpellInfo], <code>false</code> otherwise."],
        [3, "IsItemFitToSpellRequirements", "", "Returns <code>true</code> if the given <a class=\"mod\" href=\"Item/index.html\">Item</a> fits the requirements of the [ElunaSpellInfo], <code>false</code> otherwise."],
        [3, "IsLootCrafting", "", "Returns <code>true</code> if the [ElunaSpellInfo] is a loot crafting spell, <code>false</code> otherwise."],
        [3, "IsMoveAllowedChannel", "", "Returns <code>true</code> if the [ElunaSpellInfo] allows movement while channeling, <code>false</code> otherwise."],
        [3, "IsMultiSlotAura", "", "Returns <code>true</code> if the [ElunaSpellInfo] occupies multiple aura slots, <code>false</code> otherwise."],
        [3, "IsNextMeleeSwingSpell", "", "Returns <code>true</code> if the [ElunaSpellInfo] is a next melee swing spell, <code>false</code> otherwise."],
        [3, "IsPassive", "", "Returns <code>true</code> if the [ElunaSpellInfo] is a passive spell, <code>false</code> otherwise."],
        [3, "IsPassiveStackableWithRanks", "", "Returns <code>true</code> if the [ElunaSpellInfo] is a passive spell stackable with ranks, <code>false</code> otherwise."],
        [3, "IsPositive", "", "Returns <code>true</code> if the [ElunaSpellInfo] is a positive spell, <code>false</code> otherwise."],
        [3, "IsPositiveEffect", "", "Returns <code>true</code> if the effect at the given index of the [ElunaSpellInfo] is positive, <code>false</code> otherwise."],
        [3, "IsPrimaryProfession", "", "Returns <code>true</code> if the [ElunaSpellInfo] is a primary profession spell, <code>false</code> otherwise."],
        [3, "IsPrimaryProfessionFirstRank", "", "Returns <code>true</code> if the [ElunaSpellInfo] is the first rank of a primary profession spell, <code>false</code> otherwise."],
        [3, "IsProfession", "", "Returns <code>true</code> if the [ElunaSpellInfo] is a profession spell, <code>false</code> otherwise."],
        [3, "IsProfessionOrRiding", "", "Returns <code>true</code> if the [ElunaSpellInfo] is a profession or riding spell, <code>false</code> otherwise."],
        [3, "IsRangedWeaponSpell", "", "Returns <code>true</code> if the [ElunaSpellInfo] is a ranged weapon spell, <code>false</code> otherwise."],
        [3, "IsRankOf", "", "Returns <code>true</code> if the [ElunaSpellInfo] is the same rank as the given [ElunaSpellInfo], <code>false</code> otherwise."],
        [3, "IsRanked", "", "Returns <code>true</code> if the [ElunaSpellInfo] is ranked, <code>false</code> otherwise."],
        [3, "IsRequiringDeadTarget", "", "Returns <code>true</code> if the [ElunaSpellInfo] requires the target to be dead, <code>false</code> otherwise."],
        [3, "IsSelfCast", "", "Returns <code>true</code> if the [ElunaSpellInfo] is a self cast spell, <code>false</code> otherwise."],
        [3, "IsSingleTarget", "", "Returns <code>true</code> if the [ElunaSpellInfo] can only have a single target active at a time, <code>false</code> otherwise."],
        [3, "IsStackableOnOneSlotWithDifferentCasters", "", "Returns <code>true</code> if the [ElunaSpellInfo] can stack on one slot from different casters, <code>false</code> otherwise."],
        [3, "IsStackableWithRanks", "", "Returns <code>true</code> if the [ElunaSpellInfo] is stackable with ranks, <code>false</code> otherwise."],
        [3, "IsTargetingArea", "", "Returns <code>true</code> if the [ElunaSpellInfo] targets an area, <code>false</code> otherwise."],
        [3, "NeedsComboPoints", "", "Returns <code>true</code> if the [ElunaSpellInfo] requires combo points, <code>false</code> otherwise."],
        [3, "NeedsExplicitUnitTarget", "", "Returns <code>true</code> if the [ElunaSpellInfo] needs an explicit unit target, <code>false</code> otherwise."],
        [3, "NeedsToBeTriggeredByCaster", "", "Returns <code>true</code> if the [ElunaSpellInfo] needs to be triggered by the given triggering [ElunaSpellInfo], <code>false</code> otherwise."],
        [3, "SpellCancelsAuraEffect", "", "Returns <code>true</code> if the [ElunaSpellInfo] cancels the given <a class=\"mod\" href=\"AuraEffect/index.html\">AuraEffect</a>, <code>false</code> otherwise."],
    ],
    "paths": []
};searchIndex["Unit"] = {
    "items": [
